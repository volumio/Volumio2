...
function enableControls() {
  var arrayWebsocketControls = document.getElementsByClassName('control-websocket');

  for (var i = 0; i < arrayWebsocketControls.length; i++) {
...
function updateBrowseView(objBrowseData) {
  ...
  for (var i = 0; i < arrayDataKeys.length; i++) {
...
document.getElementById('button-volumioplay').onclick = function() {
  emitClientEvent('volumioPlay', '');
};
document.getElementById('button-volumiopause').onclick = function() {
  emitClientEvent('volumioPause', '');
};
document.getElementById('button-volumiostop').onclick = function() {
  emitClientEvent('volumioStop', '');
};
document.getElementById('button-volumioprev').onclick = function() {
  emitClientEvent('volumioPrevious', '');
};
document.getElementById('button-volumionext').onclick = function() {
  emitClientEvent('volumioNext', '');
};
document.getElementById('button-spopupdatetracklist').onclick = function() {
  emitClientEvent('spopUpdateTracklist', '');
};
document.getElementById('button-volumiorebuildlibrary').onclick = function() {
  emitClientEvent('volumioRebuildLibrary', '');
};
