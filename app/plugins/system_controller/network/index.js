  ...
  var defer = libQ.defer();
	 ...
	 iwlist.scan('wlan0', function (err, networks) {
					 ...
					 for (var e = 0; e < wirelessnets3.length; e++) {
						 ...
						 switch (scanResults[0]) {
							 ...
							 case 'signal':
								 ...
								 if (rel >= 65) { signal = 5; } else if (rel >= 50) { signal = 4; } else if (rel >= 40) { signal = 3; } else if (rel >= 30) { signal = 2; } else if (rel >= 1) { signal = 1; }
        ...
        exself.enrichNetworks(networksarray);
			 ...
			 } catch (e) { console.log('Cannot use fallback scanning method: ' + e); }
		 } else {
...
ControllerNetwork.prototype.getInfoNetwork = function () {
  ...
  if (wirelessqualityraw2 >= 65) { wirelessquality = 5; } else if (wirelessqualityraw2 >= 50) { wirelessquality = 4; } else if (wirelessqualityraw2 >= 40) { wirelessquality = 3; } else if (wirelessqualityraw2 >= 30) { wirelessquality = 2; } else if (wirelessqualityraw2 >= 1) { wirelessquality = 1; }
