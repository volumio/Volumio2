...
CoreCommandRouter.prototype.updateMusicLibraryBrowseSourcesVisibility= function (data) {
	var self=this;

	return this.musicLibrary.updateBrowseSourcesVisibility(data);
}

CoreCommandRouter.prototype.getBrowseSourcesVisibility= function () {
	var self=this;

	return this.musicLibrary.getBrowseSourcesVisibility();
}
